...
* Faster because we stop early

Time Complexity:
O(min(n1, n2)) (but faster in practice)
...
* When one becomes 0, the other is the answer
...
Time Complexity:
O(log(min(n1, n2)))  (very fast)

---

If you want, next I can give:

* Recursive version (very important)
* LCM using GCD (asked in exams a lot)
